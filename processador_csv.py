...
def find_last_annotation_end(lines: List[str]) -> int:
    last_index = -1
...
def create_dataframe_and_export_csv(input_text: str, csv_filename: str, narrative_name: str) -> Optional[pd.DataFrame]:
    ...
    try:
        ...
        texto_narrativa = ""
        linhas_listas_raw = []
        indice_fim_narrativa = find_last_annotation_end(linhas)
